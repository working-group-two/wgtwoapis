...
func file_wgtwo_webterminal_v0_webterminal_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Offer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Answer); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Bye); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Idle); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[6].Exporter = func(v any, i int) any {
			switch v := v.(*InCall); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Error); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[8].Exporter = func(v any, i int) any {
		...
		file_wgtwo_webterminal_v0_webterminal_proto_msgTypes[9].Exporter = func(v any, i int) any {
			switch v := v.(*Action); i {
			case 0:
				return &v.state
			case 1:
