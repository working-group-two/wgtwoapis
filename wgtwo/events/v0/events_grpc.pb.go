...
type EventsServiceClient interface {
	Subscribe(ctx context.Context, in *SubscribeEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeEventsResponse], error)
...
func (c *eventsServiceClient) Subscribe(ctx context.Context, in *SubscribeEventsRequest, opts ...grpc.CallOption) (grpc.ServerStreamingClient[SubscribeEventsResponse], error) {
...
func (c *eventsServiceClient) Ack(ctx context.Context, in *AckRequest, opts ...grpc.CallOption) (*AckResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AckResponse)
	err := c.cc.Invoke(ctx, EventsService_Ack_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type EventsServiceServer interface {
	Subscribe(*SubscribeEventsRequest, grpc.ServerStreamingServer[SubscribeEventsResponse]) error
...
func (UnimplementedEventsServiceServer) Subscribe(*SubscribeEventsRequest, grpc.ServerStreamingServer[SubscribeEventsResponse]) error {
...
func _EventsService_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(EventsServiceServer).Subscribe(m, &grpc.GenericServerStream[SubscribeEventsRequest, SubscribeEventsResponse]{ServerStream: stream})
}
