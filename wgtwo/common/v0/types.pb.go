...
func file_wgtwo_common_v0_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wgtwo_common_v0_types_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Imsi); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_common_v0_types_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Tadig); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_common_v0_types_proto_msgTypes[2].Exporter = func(v any, i int) any {
			switch v := v.(*Iccid); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_common_v0_types_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_wgtwo_common_v0_types_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_wgtwo_common_v0_types_proto_msgTypes[5].Exporter = func(v any, i int) any {
			switch v := v.(*Fqdn); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_common_v0_types_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_wgtwo_common_v0_types_proto_msgTypes[7].Exporter = func(v any, i int) any {
			switch v := v.(*Tenant); i {
			case 0:
				return &v.state
			case 1:
