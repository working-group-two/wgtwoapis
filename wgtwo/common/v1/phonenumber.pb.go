...
var file_wgtwo_common_v1_phonenumber_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x04, 0x74, 0x65, 0x78, 0x74, 0x42, 0xbd, 0x01, 0x0a, 0x13, 0x63, 0x6f, 0x6d,
	0x2e, 0x77, 0x67, 0x74, 0x77, 0x6f, 0x2e, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x6e, 0x2e, 0x76, 0x31,
	0x42, 0x10, 0x50, 0x68, 0x6f, 0x6e, 0x65, 0x6e, 0x75, 0x6d, 0x62, 0x65, 0x72, 0x50, 0x72, 0x6f,
...
func file_wgtwo_common_v1_phonenumber_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wgtwo_common_v1_phonenumber_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*E164); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_common_v1_phonenumber_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_wgtwo_common_v1_phonenumber_proto_msgTypes[2].Exporter = func(v any, i int) any {
