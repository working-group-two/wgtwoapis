...
// Enum for the status of setting a filter
...
// Enum for the categories to block
type Category int32
...
// Request message to set global filter
...
// Response message for setting global filter
...
// Request message to get global filter
...
// Response message for getting global filter
...
type Filter_BlockModeIp struct {
	// The IP address to redirect to if the category is blocked
...
var file_wgtwo_data_v1_content_filtering_proto_rawDesc = []byte{
	...
	0x74, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x3a, 0x72, 0x65, 0x61, 0x64, 0x42, 0xc3, 0x01, 0x0a, 0x11,
	0x63, 0x6f, 0x6d, 0x2e, 0x77, 0x67, 0x74, 0x77, 0x6f, 0x2e, 0x64, 0x61, 0x74, 0x61, 0x2e, 0x76,
	0x31, 0x42, 0x15, 0x43, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74, 0x46, 0x69, 0x6c, 0x74, 0x65, 0x72,
	...
	0x69, 0x73, 0x2f, 0x77, 0x67, 0x74, 0x77, 0x6f, 0x2f, 0x63, 0x6f, 0x6e, 0x74, 0x65, 0x6e, 0x74,
	0x5f, 0x66, 0x69, 0x6c, 0x74, 0x65, 0x72, 0x69, 0x6e, 0x67, 0x2f, 0x76, 0x31, 0xa2, 0x02, 0x03,
	0x57, 0x44, 0x58, 0xaa, 0x02, 0x0d, 0x57, 0x67, 0x74, 0x77, 0x6f, 0x2e, 0x44, 0x61, 0x74, 0x61,
	0x2e, 0x56, 0x31, 0xca, 0x02, 0x0d, 0x57, 0x67, 0x74, 0x77, 0x6f, 0x5c, 0x44, 0x61, 0x74, 0x61,
	0x5c, 0x56, 0x31, 0xe2, 0x02, 0x19, 0x57, 0x67, 0x74, 0x77, 0x6f, 0x5c, 0x44, 0x61, 0x74, 0x61,
	0x5c, 0x56, 0x31, 0x5c, 0x47, 0x50, 0x42, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0xea,
	0x02, 0x0f, 0x57, 0x67, 0x74, 0x77, 0x6f, 0x3a, 0x3a, 0x44, 0x61, 0x74, 0x61, 0x3a, 0x3a, 0x56,
...
var file_wgtwo_data_v1_content_filtering_proto_goTypes = []any{
...
func file_wgtwo_data_v1_content_filtering_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[4].Exporter = func(v any, i int) any {
			switch v := v.(*Filter); i {
			case 0:
				return &v.state
			case 1:
		...
		file_wgtwo_data_v1_content_filtering_proto_msgTypes[5].Exporter = func(v any, i int) any {
	...
	file_wgtwo_data_v1_content_filtering_proto_msgTypes[4].OneofWrappers = []any{
