...
const file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDesc = "" +
	"\n" +
	"&wgtwo/sipbreakout/v1/sipbreakout.proto\x12\x14wgtwo.sipbreakout.v1\x1a\x1egoogle/protobuf/duration.proto\x1a#wgtwo/annotations/annotations.proto\x1a!wgtwo/common/v1/phonenumber.proto\"c\n" +
	"\x19UpsertRegistrationRequest\x12F\n" +
	"\fregistration\x18\x01 \x01(\v2\".wgtwo.sipbreakout.v1.RegistrationR\fregistration\"\xc1\x01\n" +
	"\x1aUpsertRegistrationResponse\x12A\n" +
	"\vstatus_code\x18\x01 \x01(\x0e2 .wgtwo.sipbreakout.v1.StatusCodeR\n" +
	"statusCode\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\x12;\n" +
	"\ftime_to_live\x18\x03 \x01(\v2\x19.google.protobuf.DurationR\n" +
	"timeToLive\"c\n" +
	"\x19DeleteRegistrationRequest\x12F\n" +
	"\fregistration\x18\x01 \x01(\v2\".wgtwo.sipbreakout.v1.RegistrationR\fregistration\"\x84\x01\n" +
	"\x1aDeleteRegistrationResponse\x12A\n" +
	"\vstatus_code\x18\x01 \x01(\x0e2 .wgtwo.sipbreakout.v1.StatusCodeR\n" +
	"statusCode\x12#\n" +
	"\rerror_message\x18\x02 \x01(\tR\ferrorMessage\"\x99\x02\n" +
	"\fRegistration\x12:\n" +
	"\x19mobile_originating_prefix\x18\x01 \x01(\tR\x17mobileOriginatingPrefix\x12:\n" +
	"\x19mobile_terminating_prefix\x18\x02 \x01(\tR\x17mobileTerminatingPrefix\x12\x17\n" +
	"\asip_uri\x18\x03 \x01(\tR\x06sipUri\x12>\n" +
	"\n" +
	"route_type\x18\x04 \x01(\x0e2\x1f.wgtwo.sipbreakout.v1.RouteTypeR\trouteType\x128\n" +
	"\fphone_number\x18\x05 \x01(\v2\x15.wgtwo.common.v1.E164R\vphoneNumber*]\n" +
	"\n" +
	"StatusCode\x12\x1b\n" +
	"\x17STATUS_CODE_UNSPECIFIED\x10\x00\x12\x12\n" +
	"\x0eSTATUS_CODE_OK\x10\x01\x12\x1e\n" +
	"\x1aSTATUS_CODE_NOT_ACCEPTABLE\x10\x02*\xb2\x01\n" +
	"\tRouteType\x12\x1a\n" +
	"\x16ROUTE_TYPE_UNSPECIFIED\x10\x00\x12\x13\n" +
	"\x0fROUTE_TYPE_LOOP\x10\x01\x12\x13\n" +
	"\x0fROUTE_TYPE_FORK\x10\x02\x12\x17\n" +
	"\x13ROUTE_TYPE_FALLBACK\x10\x03\x12\x16\n" +
	"\x12ROUTE_TYPE_LOOP_MO\x10\x04\x12\x16\n" +
	"\x12ROUTE_TYPE_LOOP_MT\x10\x05\x12\x16\n" +
	"\x12ROUTE_TYPE_INGRESS\x10\x062\xb8\x02\n" +
	"\x12SipBreakoutService\x12\x8f\x01\n" +
	"\x12UpsertRegistration\x12/.wgtwo.sipbreakout.v1.UpsertRegistrationRequest\x1a0.wgtwo.sipbreakout.v1.UpsertRegistrationResponse\"\x16\xea\xb5\x18\x12call.routing:write\x12\x8f\x01\n" +
	"\x12DeleteRegistration\x12/.wgtwo.sipbreakout.v1.DeleteRegistrationRequest\x1a0.wgtwo.sipbreakout.v1.DeleteRegistrationResponse\"\x16\xea\xb5\x18\x12call.routing:writeB\xdb\x01\n" +
	"\x18com.wgtwo.sipbreakout.v1B\x10SipbreakoutProtoP\x01Z;github.com/working-group-two/wgtwoapis/wgtwo/sipbreakout/v1\xa2\x02\x03WSX\xaa\x02\x14Wgtwo.Sipbreakout.V1\xca\x02\x14Wgtwo\\Sipbreakout\\V1\xe2\x02 Wgtwo\\Sipbreakout\\V1\\GPBMetadata\xea\x02\x16Wgtwo::Sipbreakout::V1b\x06proto3"

var (
	file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDescOnce sync.Once
	file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDescData []byte
)
...
func file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDescGZIP() []byte {
	file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDescOnce.Do(func() {
		file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDesc), len(file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDesc)))
	})
...
func file_wgtwo_sipbreakout_v1_sipbreakout_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDesc), len(file_wgtwo_sipbreakout_v1_sipbreakout_proto_rawDesc)),
			NumEnums:      2,
			NumMessages:   5,
			NumExtensions: 0,
			NumServices:   1,
